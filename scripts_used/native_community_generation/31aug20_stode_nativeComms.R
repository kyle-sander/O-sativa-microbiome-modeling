  ...
  write.table(final_states, file = "~/Documents/SynCom_Modeling/NativeCommunities_stode2_final_states.csv", sep = ",", col.names = F, row.names = F, append = TRUE)
  write.table(final_parameters, file = "~/Documents/SynCom_Modeling/NativeCommunities_stode2_final_parameters.csv", sep = ",", col.names = F, row.names = F, append = TRUE)
  write.table(final_eigs, file = "~/Documents/SynCom_Modeling/NativeCommunities_stode2_final_eigs.csv", sep = ",", col.names = F, row.names = F, append = TRUE)