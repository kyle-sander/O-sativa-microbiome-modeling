...
start_amt <- 0.001
#set seed for rnorm random sampling from normal distributions - setting seed with file_number variable, which should be unique for each set
set.seed(file_number)
...
for (n in 1:num_of_comms) {
  ...
  parametersSingleKiller <- c(
    ...
    muX6 = abs(rnorm(1, mu_mean, sd = mu_sd)),
    a16 = rnorm(1, mean = param_mean, sd = param_sd),
    a61 = rnorm(1, mean = param_mean, sd = param_sd),
    a26 = rnorm(1, mean = param_mean, sd = param_sd),
    a62 = rnorm(1, mean = param_mean, sd = param_sd),
    a36 = rnorm(1, mean = param_mean, sd = param_sd),
    a63 = rnorm(1, mean = param_mean, sd = param_sd),
    a46 = rnorm(1, mean = param_mean, sd = param_sd),
    a64 = rnorm(1, mean = param_mean, sd = param_sd),
    a56 = rnorm(1, mean = param_mean, sd = param_sd),
    a65 = rnorm(1, mean = param_mean, sd = param_sd),
    a66 = abs(rnorm(1, mean = param_mean, sd = param_sd)) * -1)
...
dir.create(paste0(wrkdir, "initial_SK_and_PSC_", file_number))
dir.create(paste0(wrkdir, "initial_SK_and_PSC_", file_number, "/KillerComm_stode_community_eigs"))
dir.create(paste0(wrkdir, "initial_SK_and_PSC_", file_number, "/KillerComm_stode_community_states"))
dir.create(paste0(wrkdir, "initial_SK_and_PSC_", file_number, "/KillerComm_stode_community_parameters"))

#copy native community files into the created directory
#copying NC final parameters into set directory
#file.copy(paste0(wrkdir, "TimeStable_native_communities_parameters_201029.csv"), paste0(wrkdir, file_number))
#copying NC final states into set directory
#file.copy(paste0(wrkdir, "TimeStable_native_communities_states_201029.csv"), paste0(wrkdir, file_number))
#copying NC final eigs into set directory
#file.copy("~/Documents/SynCom_Modeling/NativeCommunities_stode_final_eigs.csv", paste0(wrkdir, file_number))
...
csvFilePathSKparams <- paste0(wrkdir, "initial_SK_and_PSC_", file_number, "/", csvFileName) 
write.table(final_parameters_singlekiller, file = csvFilePathSKparams, sep = ",", col.names = T, row.names = F)
...
csvFilePathSKstates <- paste0(wrkdir, "initial_SK_and_PSC_", file_number, "/", csvFileName) 
write.table(final_states_singlekiller, file = csvFilePathSKstates, sep = ",", col.names = F, row.names = F)

#writing single killer eigs file into directory named as file_number
csvFileName <- paste("SingleKiller_stode_final_eigs.csv")
csvFilePathSKeigs <- paste0(wrkdir, "initial_SK_and_PSC_", file_number, "/", csvFileName) 
...
for (p in 1:num_of_KillerComm) {
  ...
  csvFileName <- paste0("KillerComm_", p, "_stode_final_parameters.csv")
  csvFilePath <- paste0(wrkdir, "initial_SK_and_PSC_", file_number, "/KillerComm_stode_community_parameters/", csvFileName) 
  write.table(final_parameters_KillerComm, file = csvFilePath, sep = ",", col.names = T, row.names = F, append = TRUE)
  
  csvFileName <- paste0("KillerComm_", p, "_stode_final_states.csv")
  csvFilePath <- paste0(wrkdir, "initial_SK_and_PSC_", file_number, "/KillerComm_stode_community_states/", csvFileName) 
  write.table(final_states_KillerComm, file = csvFilePath, sep = ",", col.names = F, row.names = F, append = TRUE)
  
  csvFileName <- paste0("KillerComm_", p, "_stode_final_eigs.csv")
  csvFilePath <- paste0(wrkdir, "initial_SK_and_PSC_", file_number, "/KillerComm_stode_community_eigs/",csvFileName) 
  write.table(final_eigs_KillerComm, file = csvFilePath, sep = ",", col.names = F, row.names = F, append = TRUE)
...
SingleKillerFinStates <- read.csv(paste0(wrkdir, "initial_SK_and_PSC_", file_number, "/SingleKiller_stode_final_states.csv"), header = FALSE)
SingleKillerEigs <- read.csv(paste0(wrkdir, "initial_SK_and_PSC_", file_number, "/SingleKiller_stode_final_eigs.csv"), header = FALSE)
...
for(p in 1:num_of_KillerComm) {
  ...
  csvFileName <- paste0("KillerComm_", p, "_stode_final_eigs.csv")
  csvFilePath <- paste0(wrkdir, "initial_SK_and_PSC_", file_number, "/KillerComm_stode_community_eigs/", csvFileName) 
  commEigs <- read.table(file = csvFilePath, sep=",")
...
csvFilePath <- paste0(wrkdir, "initial_SK_and_PSC_", file_number, "/KillerCommMetrics_file_number_", file_number, ".csv") 
...
csvFilePath <- paste0(wrkdir, "initial_SK_and_PSC_", file_number, "/CombinedMetrics_file_number_", file_number, ".csv") 
write.table(combinedMetrics, file = csvFilePath, sep = ",", col.names = TRUE, row.names = F)

# sort out top for next cycle ------------------------------------------------------------------------------------------------------------------------#
KillerCommMetrics <- read.csv(paste0(wrkdir, "initial_SK_and_PSC_", file_number, "/KillerCommMetrics_file_number_", file_number, ".csv"), header = T) %>% 
  arrange(desc(.[[22]])) %>% 
  slice(1:5)

bestPSC <- as.numeric(KillerCommMetrics[, 20])

h <- 1
for (h in 1:5) {
  PSCid <- bestPSC[[h]]
  dir.create(paste0(wrkdir, "evolution_of_PSC_", PSCid))
  dir.create(paste0(wrkdir, "evolution_of_PSC_", PSCid, "/Round_0_data"))

  #reading in selected PSC parameters 
  csvFilePath <- paste0(wrkdir, "initial_SK_and_PSC_", file_number, "/KillerComm_stode_community_parameters/KillerComm_", PSCid, "_stode_final_parameters.csv")
  file.copy(csvFilePath, paste0(wrkdir, "evolution_of_PSC_", PSCid, "/Round_0_data"))

  #reading in selected PSC states
  csvFilePath <- paste0(wrkdir, "initial_SK_and_PSC_", file_number, "/KillerComm_stode_community_states/KillerComm_", PSCid, "_stode_final_states.csv")
  file.copy(csvFilePath, paste0(wrkdir, "evolution_of_PSC_", PSCid, "/Round_0_data"))

  #reading in selected PSC eigs
  csvFilePath <- paste0(wrkdir, "initial_SK_and_PSC_", file_number, "/KillerComm_stode_community_eigs/KillerComm_", PSCid, "_stode_final_eigs.csv")
  file.copy(csvFilePath, paste0(wrkdir, "evolution_of_PSC_", PSCid, "/Round_0_data"))
 
  #reading in single target species inoculation final states
  csvFilePath <- paste0(wrkdir, "initial_SK_and_PSC_", file_number, "/SingleKiller_stode_final_states.csv")
  file.copy(csvFilePath, paste0(wrkdir, "evolution_of_PSC_", PSCid, "/Round_0_data"))

  #reading in single target species inoculation final parameters
  csvFilePath <- paste0(wrkdir, "initial_SK_and_PSC_", file_number, "/SingleKiller_stode_final_parameters.csv")
  file.copy(csvFilePath, paste0(wrkdir, "evolution_of_PSC_", PSCid, "/Round_0_data"))
