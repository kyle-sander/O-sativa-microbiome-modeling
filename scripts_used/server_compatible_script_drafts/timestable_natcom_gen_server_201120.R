...
for (n in 1:natcomNumber) {
  ...
  repeat{
    ...
    if (!is.nan(timecourse[10000, 2]) & 
        ...
        rocX1 < timecourse[10000, 2] * stabilitythreshold &
        rocX2 < timecourse[10000, 3] * stabilitythreshold &
        rocX3 < timecourse[10000, 4] * stabilitythreshold &
        rocX4 < timecourse[10000, 5] * stabilitythreshold &
        rocX5 < timecourse[10000, 6] * stabilitythreshold) {
      
      # writes the details of a passed community to the output files
      final_states <- matrix(c(paste0("NatCom_", (n+(250*(core-1)))), timecourse[10000, c(2:6)]), nrow = 1)
      ...
      final_parameters <- matrix(c(paste0("NatCom_", (n+(250*(core-1)))), natcomParameters), nrow = 1)
      ...
      final_stability <- matrix(c(paste0("NatCom_", (n+(250*(core-1)))), rocX1, rocX2, rocX3, rocX4, rocX5), nrow = 1)
      ...
      final_timecourse <- cbind(rep(paste0("NatCom_", (n+(250*(core-1)))), nrow(timecourse) / 50), final_timecourse)
