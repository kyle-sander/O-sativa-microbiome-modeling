...
NativeCommunities_stode_final_parameters <- read.csv("~/Documents/SynCom_Modeling/NativeCommunities_stode_final_parameters.csv", header=FALSE)
NativeCommunities_stode_final_states <- read.csv("~/Documents/SynCom_Modeling/NativeCommunities_stode_final_states.csv", header=FALSE)
